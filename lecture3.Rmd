...
We know that the cochlea "resolves" the incoming speech signal by performing something akin to Fourier analysis. Hopefully you have learned from previous courses on Phonetics or Acoustics that Fourier analysis basically takes a complex wave (typically periodic) and decomposes it to its basic (or pure) tones, that is, all complex periodic sounds (like vowels or musical notes) are composed of multiple pure tones (or sine waves). I found the following image on the net and thought it was a nice analogy for Fourier analysis:

<p align="center">
  <img src="images/fourier_smoothie.png" width="70%" height="70%">
</p>
\

The cochlea does something very similar to this:
...
Entrainment is a more general physical concept that is evident when small amounts of energy is transferred between oscillating bodies that are initially out of phase, but soon "lock on" to a particular frequency, as in this [famous metronome experiment](https://www.youtube.com/watch?v=T58lGKREubo&t=1s).
